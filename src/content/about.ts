export const whoWeAre = {
  ...
  capabilities: [
    "Strategic advisory aligning digital investment with corporate priorities",
    "Cloud-native enterprise architecture design",
    "Advanced AI Engineering and Multi-Agent system deployment",
    "Executive Management Development Programs (MDPs)",
  ],
  businessImpactHeading: "Business Impact",
  businessImpact:
    "We bridge the gap between “Digital Immigrants” and “Digital Dragons,” transforming fragmented operations into self-optimizing enterprises that capture immediate, sustainable value.",
};

export const autonomousOrchestration = {
  heading: "The Era of Autonomous Orchestration",
  paragraphs: [
...
export const vision = {
  heading: "Our Vision – The North Star of Transformation",
  text: "Our vision is to become a globally trusted transformation partner that empowers organizations to evolve into self-optimizing, autonomous enterprises. We help traditional “Digital Immigrant” organizations establish technology as a core business competency.",
};

export const mission = {
  heading: "Our Mission – Engineering the Future of Work",
  text: "Our mission is to combine strategic consulting, enterprise engineering, and advanced AI to systematically eliminate operational waste and create sustainable value. We are dedicated to delivering not just tech, but the leadership confidence required to lead change.",
};

// TODO(owner): replace bios and linkedin URLs with real content per leader; photo is an initials
...
export const globalPresence = {
  heading: "A Global Footprint of Engineering Excellence",
  text: "Headquartered in India's leading technology hub, AITEK serves organizations worldwide with a highly sophisticated global delivery model. We connect elite engineering talent with local strategic advisory across key economic regions.",
  locations: [
    "Hyderabad, Telangana, India (Headquarters)",
    "Singapore",
    "Australia",
    "Qatar",
  ...
  quote:
    "Our global network ensures that no matter where your enterprise operates, you receive high-touch consulting, elite engineering, and total compliance with local regulatory requirements.",
};
